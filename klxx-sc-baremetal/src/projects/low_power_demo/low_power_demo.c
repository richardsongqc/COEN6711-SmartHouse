	...
	while(1)
	{
            ...
            switch(test_num){
              case 0://VLLS0 no POR
                ...
                printf("Press SW4 to wake up from VLLS0\n\r ");
                clockMonitor(OFF);
                set_4_lp(0);
                enter_vlls0(1);
                break;
             ...
             case 1://VLLS0
                ...
                uart0_getchar(UART0_BASE_PTR);
                printf("\n\rPress SW4 to wake up from VLLS0\n\r ");
                clockMonitor(OFF);
                set_4_lp(0);
                enter_vlls0(0);
                break;
              ...
              case 2://VLLS1
                ...
                uart0_getchar(UART0_BASE_PTR);
                printf("Press SW4 to wake up from VLLS1\n\r ");
                clockMonitor(OFF);     
                set_4_lp(0);
                enter_vlls1();
                break;
              ...
              case 5://LLS
                ...
                uart0_getchar(UART0_BASE_PTR);
                printf("Press SW4 to wake up from LLS\n\r ");
                clockMonitor(OFF); 
                set_4_lp(0);
                enter_lls();
                set_4_lp(1);
...
void Port_Init(int io_nmi){
  ...
  if (buttons_read == 0x8) {  // SW3 buttons not -pressed
    ...
    #ifndef FREEDOM
    printf("\n\r*-------Press SW4 then press Reset to re-enable debug---------*");
    #endif
    } else {
    printf("\n\r*--------------D E B U G    E N A B L E D--------------------*");
  }
