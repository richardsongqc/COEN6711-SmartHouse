...
__vector_table
        ...
        DCD     0                         ; 5:  reserved
        DCD     FLASH_CC_IRQHandler       ; 6:  FTFL interrupt
        DCD     FLASH_RC_IRQHandler       ; 7:  Read collision interrupt
        ...
        DCD     I2STX_IRQHandler            ;13:  I2S0 tx interrupt
        DCD     I2SRX_IRQHandler            ;14:  I2S0 rx interrupt
        DCD     UART0_LON_IRQHandler      ;15:  UART 0 LON
        DCD     UART0_IRQHandler          ;16:  UART 0 interrupt
        DCD     UART0_ERR_IRQHandler      ;17:  UART 0 error intertrupt
        DCD     UART1_IRQHandler          ;18:  UART 1 interrupt
        DCD     UART1_ERR_IRQHandler      ;19:  UART 1 error intertrupt
        DCD     UART2_IRQHandler          ;20:  UART 2 interrupt
        ...
        DCD     RTC_IRQHandler            ;28:  RTC interrupt
        DCD     RTCSEC_IRQHandler         ;29:  RTC seconds interrupt
#if MAX_TIMER_OBJECTS
        DCD     Timer_ISR                 ;30:  PIT 0 interrupt
#else
        ...
        DCD     PORTE_IRQHandler          ;45:  Software interrupt
...
;;
      ...
      PUBWEAK I2STX_IRQHandler      
      PUBWEAK I2SRX_IRQHandler      
