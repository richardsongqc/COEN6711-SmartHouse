...
return;
 ...
 static __declspec(vectortable) tVectorTable __vector_table = { /* Interrupt vector table */
...
#ifdef USED_PIT0
   (tIsrFunc)Timer_ISR,           	  /* 0x2E  0x000000B8   -   ivINT_PIT0                     unused by PE */
#else
   (tIsrFunc)Cpu_Interrupt,           /* 0x2E  0x000000B8   -   ivINT_PIT0                     unused by PE */
#endif
#ifdef USED_PIT1
   (tIsrFunc)pit1_isr,           	  /* 0x2F  0x000000BC   -   ivINT_PIT1                      unused by PE */
#else
   ...
   (tIsrFunc)USB_ISR,                 /* 0x33  0x000000CC   -   ivINT_CAN0_IMEU                unused by PE */
