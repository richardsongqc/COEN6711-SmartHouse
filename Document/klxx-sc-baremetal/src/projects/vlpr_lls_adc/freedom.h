...
/* tower module LED defines */
  #define LED0_EN (PORTB_PCR18 = PORT_PCR_MUX(1))
  #define LED1_EN (PORTB_PCR19 = PORT_PCR_MUX(1))
  #define LED2_EN (PORTD_PCR1 = PORT_PCR_MUX(1))
  #define LED3_EN 
  ...
  #define LED0_TOGGLE (GPIOB_PTOR = (1<<18))
  #define LED1_TOGGLE (GPIOB_PTOR = (1<<19))
  #define LED2_TOGGLE (GPIOD_PTOR = (1<<1))
  #define LED3_TOGGLE 

  #define LED0_OFF (GPIOB_PSOR = (1<<18))
  #define LED1_OFF (GPIOB_PSOR = (1<<19))
  #define LED2_OFF (GPIOD_PSOR = (1<<1))
  #define LED3_OFF 

  #define LED0_ON (GPIOB_PCOR = (1<<18))
  #define LED1_ON (GPIOB_PCOR = (1<<19))
  #define LED2_ON (GPIOD_PCOR = (1<<1))
  #define LED3_ON 
  /* fast GPIO through IOPORT */
  #define _LED0_TOGGLE (FGPIOB_PTOR = (1<<18))
  #define _LED1_TOGGLE (FGPIOB_PTOR = (1<<19))
  #define _LED2_TOGGLE (FGPIOD_PTOR = (1<<1))
  #define _LED3_TOGGLE 
  //OR
  #define F_LED0_TOGGLE (FGPIOB_PTOR = (1<<18))
  #define F_LED1_TOGGLE (FGPIOB_PTOR = (1<<19))
  #define F_LED2_TOGGLE (FGPIOD_PTOR = (1<<1))
  #define F_LED3_TOGGLE 

  #define F_LED0_OFF (FGPIOB_PSOR = (1<<18))
  #define F_LED1_OFF (FGPIOB_PSOR = (1<<19))
  #define F_LED2_OFF (FGPIOD_PSOR = (1<<1))
  #define F_LED3_OFF 
  
  #define F_LED0_ON (FGPIOB_PCOR = (1<<18))
  #define F_LED1_ON (FGPIOB_PCOR = (1<<19))
  #define F_LED2_ON (FGPIOD_PCOR = (1<<1))
  #define F_LED3_ON 
